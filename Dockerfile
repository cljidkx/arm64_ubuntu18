...
RUN apt install -y git libssl-dev liblz4-tool \
	expect-dev patchelf chrpath gawk texinfo diffstat binfmt-support \
	live-build bison flex fakeroot cmake \
	unzip device-tree-compiler python3-pip ncurses-dev python-pyelftools \
	subversion asciidoc w3m dblatex graphviz python3-matplotlib cpio \
